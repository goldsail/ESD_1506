...
{
    #ifdef ISR_UART_1_INTERRUPT_INTERRUPT_CALLBACK
        ISR_UART_1_Interrupt_InterruptCallback();
    #endif /* ISR_UART_1_INTERRUPT_INTERRUPT_CALLBACK */ 
...
void ISR_UART_1_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)ISR_UART_1__INTC_NUMBER] = address;
}
...
cyisraddress ISR_UART_1_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)ISR_UART_1__INTC_NUMBER];
}
...
*
*   Note calling ISR_UART_1_Start or ISR_UART_1_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after ISR_UART_1_Start or ISR_UART_1_StartEx has been called. 
...
{
    *ISR_UART_1_INTC_PRIOR = priority << 5;
}
...
uint8 ISR_UART_1_GetPriority(void)
{
    ...
    priority = *ISR_UART_1_INTC_PRIOR >> 5;
