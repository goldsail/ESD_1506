...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT6_AMUX, 0x0140u);
...
uint8 CYXDATA * const CYCODE ADC_1506_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE ADC_1506_AMux__maskTable[2] = {
	0x40u, 
	0x00u, 
};

/*******************************************************************************
* Function Name: ADC_1506_AMux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_1506_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_1506_AMux__addrTable[channel] |= ADC_1506_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: ADC_1506_AMux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_1506_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_1506_AMux__addrTable[channel] &= (uint8)~ADC_1506_AMux__maskTable[channel];
	}
}
