// ======================================================================
// Voice_Recorder_1506.v generated from TopDesign.cysch
// 09/01/2017 at 14:35
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=255, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=2, Voltage=4080, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC_1506, CY_INSTANCE_SHORT_NAME=VDAC_1506, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=VDAC_1506, )
...
// OpAmp_v1_90(Mode=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp_1506, CY_INSTANCE_SHORT_NAME=Opamp_1506, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 SP1, INSTANCE_NAME=Opamp_1506, )
...
module top ;
    ...
    CharLCD_v2_20_0 LCD_1506 ();

    VDAC8_v1_90_1 VDAC_1506 (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_283));
    defparam VDAC_1506.Data_Source = 0;
    defparam VDAC_1506.Initial_Value = 255;
    defparam VDAC_1506.Strobe_Mode = 0;

	wire [0:0] tmpOE__Sin_net;
	wire [0:0] tmpFB_0__Sin_net;
	wire [0:0] tmpIO_0__Sin_net;
	wire [0:0] tmpINTERRUPT_0__Sin_net;
	electrical [0:0] tmpSIOVREF__Sin_net;
	...
	cy_psoc3_pins_v1_10
		...
		Sin
		 (.oe(tmpOE__Sin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Sin_net[0:0]}),
		  .analog({Net_333}),
		  .io({tmpIO_0__Sin_net[0:0]}),
		  .siovref(tmpSIOVREF__Sin_net),
		  .interrupt({tmpINTERRUPT_0__Sin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    USBFS_v3_0_2 USBUART_1506 (
        .sof(Net_296),
        .vbusdet(1'b0));
    defparam USBUART_1506.epDMAautoOptimization = 0;

    ADC_DelSig_v3_20_3 ADC_1506 (
        .vplus(Net_333),
        .vminus(Net_387),
        .soc(1'b1),
        .eoc(Net_389),
