...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../IR_LCD_Qsys.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x100016a0
SOPC_SYSID_FLAG += --sidp=0x100016a0
ELF_PATCH_FLAG  += --sidp 0x100016a0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1504073683
SOPC_SYSID_FLAG += --timestamp=1504073683
ELF_PATCH_FLAG  += --timestamp 1504073683
