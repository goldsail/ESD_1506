...
extern void ADC_1506_AMux_Set(uint8 channel);
extern void ADC_1506_AMux_Unset(uint8 channel);
/* ADC_1506_AMux__addrTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern uint8 CYXDATA * const CYCODE ADC_1506_AMux__addrTable[2];
/* ADC_1506_AMux__maskTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern const uint8 CYCODE ADC_1506_AMux__maskTable[2];
